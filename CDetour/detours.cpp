...
#if defined(_WIN64) || defined(__x86_64__)
	int shortBytes = copy_bytes((unsigned char *)detour_address, nullptr, OP_JMP_SIZE);
	detour_restore.bytes = copy_bytes((unsigned char *)detour_address, nullptr, X64_ABS_SIZE);
#else
	detour_restore.bytes = copy_bytes((unsigned char *)detour_address, nullptr, OP_JMP_SIZE);
#endif
